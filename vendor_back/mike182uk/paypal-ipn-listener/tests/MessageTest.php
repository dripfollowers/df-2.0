...
class MessageTest extends PHPUnit_Framework_TestCase {
    ...
    public function testCreateFromGlobals() {
        ...
        $ipnMessage = $this->getMockClass ( 'PayPal\Ipn\Message', array ('getRawPost' 
        ) );
        
        $ipnMessage::staticExpects ( $this->any () )->method ( 'getRawPost' )->will ( $this->returnValue ( 'param1=value1&param2=value2' ) );
