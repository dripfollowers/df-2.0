...
class VerifierTest extends PHPUnit_Framework_TestCase {
    ...
    public function testVerify() {
        ...
        $verifier->expects ( $this->at ( 0 ) )->method ( 'sendVerificationRequest' )->will ( $this->returnValue ( new VerificationResponse ( 'INVALID', 200 ) ) );
        
        $verifier->expects ( $this->at ( 1 ) )->method ( 'sendVerificationRequest' )->will ( $this->returnValue ( new VerificationResponse ( 'VERIFIED', 200 ) ) );
    ...
    public function testVerifyThrowsExceptionOnUnexpectedResponseBody() {
        ...
        $verifier->expects ( $this->any () )->method ( 'sendVerificationRequest' )->will ( $this->returnValue ( new VerificationResponse ( '', 200 ) ) );
    ...
    public function testVerifyThrowsExceptionOnUnexpectedStatusCode() {
        ...
        $verifier->expects ( $this->any () )->method ( 'sendVerificationRequest' )->will ( $this->returnValue ( new VerificationResponse ( 'INVALID', 300 ) ) );
