...
class InstagramIgersViewsService extends InstagramIgersService {
    ...
    protected function set_data($params) {
        ...
        $count = $params ['count'];
		$this->_data = 'key=' . $this->_service_access_id . '&action=order_add&type=ig_views&link='.$target.'&amount='.$count;
    }
