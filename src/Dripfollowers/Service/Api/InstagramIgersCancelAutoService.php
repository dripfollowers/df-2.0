...
class InstagramIgersCancelAutoService extends InstagramIgersService {
...
action - automatic_stop
order_id - The id of the order to stop

*/	   
        $this->_data = 'key=' . $this->_service_access_id . '&action=automatic_stop&order_id=' . $task_id;
    }
